...
function addTab( id , title , url) {
    ...
    var nav = '<li class="am-active"><span class="am-icon-close"></span>' + '<a href="javascript: void(0)">' + title + '</a></li>';
    var iframeHtml = '<iframe scrolling="auto" frameborder="0" src="' + url + '" height="100%" width="100%"></iframe>';
    var content = '<div class="am-tab-panel am-active">' + iframeHtml + '</div>';
